    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
	         ...
	         <div class="form-group">
	        	<label for="quantity" class="col-sm-3 control-label">Product Cost: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="product-cost" placeholder="Product cost" name="product-cost" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->
	          <div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">Transport Cost (p/l): </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="transport" placeholder="Transport Cost" name="transport" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->

	          <div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">Bottel Cost: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="bottel" placeholder="Bottel Cost" name="bottel" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->

	          <div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">Margin Cost: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="margin" placeholder="Margin Cost" name="margin" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->
	        <div class="form-group">
				  ...
				  <div class="tab-content">
			        ...
			        <div class="form-group">
			         ...
			         <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editproduct-cost" placeholder="Product cost" name="editproduct-cost" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->
			          <div class="form-group">
			        	<label for="rate" class="col-sm-3 control-label">Transport Cost (p/l): </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="edittransport" placeholder="Transport Cost" name="edittransport" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->
			          ...
			          <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editbottel" placeholder="Bottel Cost" name="editbottel" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->
			          ...
			          <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editmargin" placeholder="Margin Cost" name="editmargin" autocomplete="off">
						    </div>
			        </div> <!-- /form-group-->
