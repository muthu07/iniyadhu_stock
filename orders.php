...
.tt-dropdown-menu {
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <!--/form-group-->
				...
				<div class="form-group">
			    <label for="clientId" class="col-sm-2 control-label">Select Client</label>
			    <div class="col-sm-3">
			      <input type="text" class="form-control" id="clientId" name="clientId" placeholder="Select Client" />
			    </div>
					<div class="col-sm-1">
						OR
					</div>
					<div class="col-sm-2">
							<a class="btn btn-success" href="customer.php">Add new customer</a>
					</div>
			  </div>
			  <!--/form-group-->
			  <div class="form-group">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
  			...
  			$sql = "SELECT orders.order_id, orders.order_date, orders.client_id, orders.client_name, orders.client_contact, orders.sub_total, orders.vat, orders.total_amount, orders.discount, orders.grand_total, orders.paid, orders.due, orders.payment_type, orders.payment_status FROM orders
			  ...
			  <div class="form-group">
				...
				<div class="form-group">
				 <label for="clientId" class="col-sm-2 control-label">Client Name</label>
				 <div class="col-sm-10">
					 <input type="text" class="form-control" id="clientId" name="clientId" placeholder="Client Name" autocomplete="off" value="<?php echo $data[2] ?>" />
				 </div>
			 </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Client Name</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Client Name" autocomplete="off" value="<?php echo $data[3] ?>" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">Client Contact</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="Contact Number" autocomplete="off" value="<?php echo $data[4] ?>" />
			    </div>
			  </div> <!--/form-group-->
