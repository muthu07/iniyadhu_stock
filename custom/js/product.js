	...
	if(productId) {
		...
		$.ajax({
		  ...
		  // 		allowedFileExtensions: ["jpg", "png", "gif", "JPG", "PNG", "GIF"]
				...
				$("#editproduct-cost").val(response.product_cost);
				$("#edittransport").val(response.transport_cost);
				$("#editbottel").val(response.bottel_cost);
				$("#editmargin").val(response.margin_cost);
				// quantity
				...
				$("#editProductForm").unbind('submit').bind('submit', function() {
					...
					var productImage = $("#editProductImage").val(),
						...
						productCost = $("#editproduct-cost").val(),
						transport = $("#edittransport").val(),
						bottel = $("#editbottel").val(),
						margin = $("#editmargin").val(),
					...
					if(productCost == "") {
						$("#editproduct-cost").after('<p class="text-danger">Product cost Name field is required</p>');
						$('#editproduct-cost').closest('.form-group').addClass('has-error');
					}	else {
						// remov error text field
						$("#editproduct-cost").find('.text-danger').remove();
						// success out for form
						$("#editproduct-cost").closest('.form-group').addClass('has-success');
					}	// /else

					if(transport == "") {
						$("#edittransport").after('<p class="text-danger">Transport cost field is required</p>');
						$('#edittransport').closest('.form-group').addClass('has-error');
					}	else {
						// remov error text field
						$("#edittransport").find('.text-danger').remove();
						// success out for form
						$("#edittransport").closest('.form-group').addClass('has-success');
					}	// /else

					if(bottel == "") {
						$("#editbottel").after('<p class="text-danger">Bottel cost field is required</p>');
						$('#editbottel').closest('.form-group').addClass('has-error');
					}	else {
						// remov error text field
						$("#editbottel").find('.text-danger').remove();
						// success out for form
						$("#editbottel").closest('.form-group').addClass('has-success');
					}	// /else

					if(margin == "") {
						$("#editmargin").after('<p class="text-danger">Margin cost field is required</p>');
						$('#editmargin').closest('.form-group').addClass('has-error');
					}	else {
						// remov error text field
						$("#editmargin").find('.text-danger').remove();
						// success out for form
						$("#editmargin").closest('.form-group').addClass('has-success');
					}	// /else
